 ...
 *
 */
//    Spec Last Modified Time: 2015-09-16 16:40:28
...
// ---------------------- formats below couldn't be used by HW ------------------------
    HSF_S8_UINT_D24_UNORM                    = 402, // packed format, this formats is actually never used and recognized by HW, Depth bits are in high part[31~8]: OGL only
    HSF_D24_UNORM_S8_UINT                    = 403, // packed format, Depth bits are in low part[23~0]: DX only
    ...
    HSF_BC7_TYPELESS                         = 417,

    HSF_NV21                                 = 418,//cne001 support
    HSF_I420                                 = 419,//cne001 support
    HSF_YUV888                               = 420,//cne001 support
    HSF_RGB888_PLANAR                        = 421,//cne001 support
    HSF_RGB888_PACKED                        = 422,//cne001 support
} Hw_Surf_Format;

typedef enum COMPRESS_MXUFORMAT
{
    CP_OFF                  = 0,        //RANGE_OFF = 0,
    CP_R8G8B8A8_T           = 1,        //RGBAX8888_TILE = 1,
    CP_R8G8B8A8_L           = 2,        //RGBAX8888_LINEAR =  2,
    CP_A8R8G8B8_T           = 3,        //XARGB8888_TILE = 3,
    CP_A8R8G8B8_L           = 4,        //XARGB8888_LINEAR = 4,
    CP_R10G10B10A2          = 5,        //R10G10B10A2_LINEAR = 5,
    CP_A2B10G10R10          = 6,        //A2B10G10R10_LINEAR = 6,
    CP_R11G11B10            = 7,        //R11G11B10_LINEAR = 7,
    CP_R5G6B5               = 8,        //R5G6B5_TILE = 8,
    CP_NV12                 = 9,        //YCRCB_MB_8_420 = 9,
    CP_YUYV                 = 10,       //YUYV_LINEAR = 10,
    CP_UYVY                 = 11,       //UYVY_LINEAR = 11,
    CP_R10G10B10A2_T        = 12,       //R10G10B10A2_TILE = 12,
    CP_A2B10G10R10_T        = 13,       //A2B10G10R10_TILE = 13,
    CP_NV12_10              = 14,       //NV12_10 = 14,
    CP_Z32                  = 15,       //Z32 = 15,
    CP_R16G16B16A16_T       = 16,       //R16G16B16A16_TILE = 16,
    CP_Z16                  = 17,       //Z16 = 17,
    CP_Z24                  = 18,       //Z24 = 18,
    CP_R11G11B10_T          = 19,       //R11G11B10_TILE = 19,
    CP_RGBAX8888_TILE_4X    = 20,       //RGBAX8888_TILE_4X = 20,
    CP_XARGB8888_TILE_4X    = 21,       //XARGB8888_TILE_4X = 21,
    CP_Z16_4X               = 22,       //Z16_4X = 22,
    CP_Z24_4X               = 23,       //Z24_4X = 23,
    CP_Z32_4X               = 24,       //Z32_4X = 24,
    CP_RGBAX8888_TILE_2X    = 25,       //RGBAX8888_TILE_2X = 25,
    CP_XARGB8888_TILE_2X    = 26,       //XARGB8888_TILE_2X = 26,
    CP_Z16_2X               = 27,       //Z16_2X = 27,
    CP_Z24_2X               = 28,       //Z24_2X = 28,
    CP_Z32_2X               = 29,       //Z32_2X = 29,
    CP_RGBAX8888_TILE_8X    = 30,       //RGBAX8888_TILE_8X = 30,
    CP_XARGB8888_TILE_8X    = 31,       //XARGB8888_TILE_8X = 31,
    CP_Z16_8X               = 32,       //Z16_8X = 32,
    CP_Z24_8X               = 33,       //Z24_8X = 33,
    CP_Z32_8X               = 34,       //Z32_8X = 34,
    CP_BAYER                = 35,       //BAYER = 35,
    CP_R32G32B32A32_TILE    = 36,       //R32G32B32A32_TILE = 36,
    CP_RGBAX8888_TILE_16X   = 37,       //RGBAX8888_TILE_16X = 37,
    CP_XARGB8888_TILE_16X   = 38,       //XARGB8888_TILE_16X = 38,
    CP_Z16_16X              = 39,       //Z16_16X = 39,
    CP_Z24_16X              = 40,       //Z24_16X = 40,
    CP_Z32_16X              = 41,       //Z32_16X = 41,
    CP_TOTAL_RANGE          = 42,       //TOTAL_RANGE = 42,
}COMPRESS_MXUFORMAT;
...
{\
    ...
    128,    /*HSF_BC7_TYPELESS                         = 417,*/\
    }\
//As the bit count table does, we now set 291 formats to the surface format mode table. If need more, add them.
#define SURFACE_FORMAT_MODE_E3K \
   {\
   ...
   PS_OUT_FMT_O0_DATA_FMT_UNORM8,    /*HSF_L4A4_UNORM                = 190*/\
   PS_OUT_FMT_O0_DATA_FMT_UNORM8,    /*HSF_A4L4_UNORM                = 191*/\
   ...
   PS_OUT_FMT_O0_DATA_FMT_UNORM8,     /*HSF_UYVY                      = 234?PS_OUT_FMT_O0_DATA_FMT_UNORM10*/\
   ...
   PS_OUT_FMT_O0_DATA_FMT_UNORM16,      /*HSF_I12_UNORM                 = 244*/\
   PS_OUT_FMT_O0_DATA_FMT_UNORM16,      /*HSF_I16_UNORM                 = 245*/\
   PS_OUT_FMT_O0_DATA_FMT_UNORM8,      /*HSF_I4_UNORM                  = 246*/\
   PS_OUT_FMT_O0_DATA_FMT_UNORM8,      /*HSF_I8_UNORM                  = 247*/\
   ...
   PS_OUT_FMT_O0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_6x6x6_SRGB                 = 378,*/\
    ...
    PS_OUT_FMT_O0_DATA_FMT_UNORM10,     /*HSF_R10G10B10X2_UNORM                    = 393,*/\
    ...
    PS_OUT_FMT_O0_DATA_FMT_FP32,          /*HSF_BC7_TYPELESS                        = 417,*/\
   }
//As the bit count table does, we now set 291 formats to the surface format mode table. If need more, add them.
#define SURFACE_FORMAT_MODE_CHX004 \
   {\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_UNKNOWN                   = 0,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R64G64B64A64_FLOAT        = 1,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R64G64B64_FLOAT           = 2,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_TYPELESS     = 3,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_FLOAT        = 4,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT32, /* HSF_R32G32B32A32_UINT         = 5,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT32, /* HSF_R32G32B32A32_SINT         = 6,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_SNORM        = 7,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_SCALE        = 8,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_UNORM        = 9,   */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_USCALE       = 10,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32A32_FIX          = 11,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R64G64_FLOAT              = 12,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_TYPELESS        = 13,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_FLOAT           = 14,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT32, /* HSF_R32G32B32_UINT            = 15,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_SINT            = 16,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_UNORM           = 17,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_USCALE          = 18,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_SNORM           = 19,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_SCALE           = 20,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32B32_FIX             = 21,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16, /* HSF_R16G16B16A16_TYPELESS     = 22,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16, /* HSF_R16G16B16A16_FLOAT        = 23,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16, /* HSF_R16G16B16A16_UNORM        = 24,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT16, /* HSF_R16G16B16A16_UINT         = 25,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM16, /* HSF_R16G16B16A16_SNORM        = 26,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT16, /* HSF_R16G16B16A16_SINT         = 27,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R16G16B16A16_SCALE        = 28,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R16G16B16A16_USCALE       = 29,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R16G16B16A16_SSCALE       = 30,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16, /* HSF_R12G12B12A12_UNORM        = 31,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16, /* HSF_R16G16B16_FLOAT           = 32,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT16, /* HSF_R16G16B16_SINT            = 33,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM16, /* HSF_R16G16B16_SNORM           = 34,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R16G16B16_SCALE           = 35,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT16, /* HSF_R16G16B16_UINT            = 36,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16, /* HSF_R16G16B16_UNORM           = 37,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R16G16B16_USCALE          = 38,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_TYPELESS           = 39,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_FLOAT              = 40,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT32, /* HSF_R32G32_UINT               = 41,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_SINT               = 42,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_SNORM              = 43,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_SCALE              = 44,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_UNORM              = 45,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_USCALE             = 46,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G32_FIX                = 47,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /* HSF_R32G8X24_TYPELESS         = 48,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_D32_FLOAT_S8X24_UINT      = 49, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R32_FLOAT_X8X24_TYPELESS  = 50, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_X32_TYPELESS_G8X24_UINT   = 51, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R64_FLOAT                 = 52, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R12G12B12_UNORM           = 53, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10A2_TYPELESS      = 54, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10A2_UNORM         = 55, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT16, /*  HSF_R10G10B10A2_UINT          = 56, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT16, /*  HSF_R10G10B10X2_UINT          = 57, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10X2_USCALE        = 58, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10A2_SNORM         = 59, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10A2_SINT          = 60, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10X2_SNORM         = 61, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_B10G10R10A2_SNORM         = 62, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_B10G10R10A2_UNORM         = 63, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_B10G10R10X2_UNORM         = 64, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_A2B10G10R10_UNORM         = 65, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_A2B10G10R10_SNORM         = 66, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_A2B10G10R10_USCALE        = 67, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_A2B10G10R10_SSCALE        = 68, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10_SINT            = 69, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10_SNORM           = 70, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R10G10B10_SCALE           = 71, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10_UNIT            = 72, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10B10_UNORM           = 73, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R10G10B10_USCALE          = 74, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10_SINT               = 75, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10_SNORM              = 76, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R10G10_SCALE              = 77, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10_UINT               = 78, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10, /*  HSF_R10G10_UNORM              = 79, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R10G10_USCALE             = 80, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_R10G10B10_FLOAT_A2_UNORM  = 81, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16, /*  HSF_R11G11B10_FLOAT           = 82, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32, /*  HSF_B10G11R11_FLOAT           = 83, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16, /*  HSF_R11G11_FLOAT              = 84, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8, /*  HSF_R8G8B8A8_TYPELESS         = 85, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8, /*  HSF_R8G8B8A8_UNORM            = 86, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_R8G8B8A8_UNORM_SRGB       = 87*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R8G8B8X8_UNORM            = 88*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B8G8R8A8_UNORM            = 89*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_B8G8R8A8_UNORM_SRGB       = 90*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B8G8R8X8_UNORM            = 91*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_B8G8R8X8_UNORM_SRGB       = 92*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_X8R8G8B8_UNORM            = 93*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_X8B8G8R8_UNORM            = 94*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_A8R8G8B8_UNORM            = 95*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_A8B8G8R8_UNORM            = 96*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT8,     /*HSF_R8G8B8A8_UINT             = 97*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM8,     /*HSF_R8G8B8A8_SNORM            = 98*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT8,     /*HSF_R8G8B8A8_SINT             = 99*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B8G8R8A8_XNORM          = 100?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8B8A8_SSCALE           = 101?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8B8A8_USCALE           = 102*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT8,     /*HSF_R8G8B8_SINT               = 103*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM8,     /*HSF_R8G8B8_SNORM              = 104*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8B8_SCALE              = 105?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT8,     /*HSF_R8G8B8_UINT               = 106*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R8G8B8_UNORM              = 107*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8B8_USCALE             = 108?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_R16G16_TYPELESS           = 109?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_R16G16_FLOAT              = 110*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_R16G16_UNORM              = 111*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT16,     /*HSF_R16G16_UINT               = 112*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM16,     /*HSF_R16G16_SNORM              = 113*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT16,     /*HSF_R16G16_SINT               = 114*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16G16_SCALE              = 115?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16G16_USCALE             = 116?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16G16_SSCALE             = 117?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_TYPELESS              = 118?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_D32_FLOAT                 = 119*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_D32_UNORM                 = 120?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_FLOAT                 = 121*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_UINT                  = 122?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_SINT                  = 123?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_UNORM                 = 124?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_USCALE                = 125*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_SNORM                 = 126*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_SCALE                 = 127*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_FIX                   = 128*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R24G8_TYPELESS            = 129*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_D32_FLOAT_S8_UINT         = 130*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_D24_UNORM_S8_UINT         = 131*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R24_UNORM_X8_TYPELESS     = 132*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_X24_TYPELESS_G8_UINT      = 133*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM24,     /*HSF_D24_UNORM                 = 134*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R24_FLOAT                 = 135*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R8G8_TYPELESS             = 136?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R8G8_UNORM                = 137*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT8,     /*HSF_R8G8_UINT                 = 138*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM8,     /*HSF_R8G8_SNORM                = 139*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT8,     /*HSF_R8G8_SINT                 = 140*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8_USCALE               = 141*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8_SSCALE               = 142*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16_TYPELESS              = 143*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_R16_FLOAT                 = 144*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_D16_UNORM                 = 145*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_R16_UNORM                 = 146*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT16,     /*HSF_R16_UINT                  = 147*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM16,     /*HSF_R16_SNORM                 = 148*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT16,     /*HSF_R16_SINT                  = 149*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16_USCALE                = 150?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16_SSCALE                = 151?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_A16_UNORM                 = 152*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B5G6R5_UNORM              = 153*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R5G6B5_UNORM              = 154*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B5G5R5X1_UNORM            = 155*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B5G5R5A1_UNORM            = 156*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R5G5B5A1_UNORM            = 157*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_A1B5G5R5_UNORM            = 158*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_A1R5G5B5_UNORM            = 159*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B4G4R4A4_UNORM            = 160*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_B4G4R4X4_UNORM            = 161*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R4G4B4A4_UNORM            = 162*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_A4B4G4R4_UNORM            = 163*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_A4R4G4B4_UNORM            = 164*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R4G4B4_UNORM              = 165*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R5G5B5_UNORM              = 166*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_U5V5L6_XNORM              = 167?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_L16_UNORM                 = 168*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_L8_A8_UNORM               = 169*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10_SINT                  = 170?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10_SNORM                 = 171?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10_SCALE                 = 172?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10_UINT                  = 173?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10_UNORM                 = 174?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10_USCALE                = 175?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_R2G2B2A2_UNORM            = 176?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_R8_TYPELESS               = 177?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_R8_UNORM                  = 178*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT8,      /*HSF_R8_UINT                   = 179*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SNORM8,      /*HSF_R8_SNORM                  = 180*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_SINT8,      /*HSF_R8_SINT                   = 181*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_R8_USCALE                 = 182?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_R8_SSCALE                 = 183?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_A8_UNORM                  = 184*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_L8_UNORM                  = 185*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_A12_UNORM                 = 186*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_A4_UNORM                  = 187*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_R1_UNORM                  = 188*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_R3G3B2_UNORM              = 189*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_L4A4_UNORM                = 190*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_A4L4_UNORM                = 191*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_L4A4_VIDEO                = 192*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10,     /*HSF_AYUV_VIDEO                = 193*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_YUYV                      = 194*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_NV12                      = 195?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_P010                      = 196?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_P016                      = 197?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R9G9B9E5_SHAREDEXP        = 198?UINT16*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8_B8G8_UNORM           = 199*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_G8R8_G8B8_UNORM           = 200*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_BC1_UNORM                 = 201*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_BC1_UNORM_SRGB            = 202*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_BC2_UNORM                 = 203*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_BC2_UNORM_SRGB            = 204*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_BC3_UNORM                 = 205*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_BC3_UNORM_SRGB            = 206*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_BC4_UNORM                 = 207*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_BC4_SNORM                 = 208*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_BC4_UNORM_L               = 209*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_BC4_SNORM_L               = 210*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC5_UNORM                 = 211*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC5_SNORM                 = 212*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC5_UNORM_LA              = 213*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC5_SNORM_LA              = 214*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC6H_UF16                 = 215*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC6H_SF16                 = 216*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_BC7_UNORM                 = 217*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_BC7_UNORM_SRGB            = 218*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UINT8,      /*HSF_G8_UINT                   = 219?0?UNORM8*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_3DC_UNORM                 = 220*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_YUY2                      = 221*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_Y216_VIDEO                = 222*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_Y210_VIDEO                = 223*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_A4I4_VIDEO                = 224?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_A8L8_UNORM                = 225*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_L8A8_UNORM                = 226*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_ZL1                       = 227*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_YCRCB_MB_8_420            = 228*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_YCRCB_MB_8_422            = 229*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_YCRCB_MB_16_420           = 230*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_YCRCB_MB_16_422           = 231*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_P016T                     = 232?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10,     /*HSF_UYVA1010102_VIDEO         = 233?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_UYVY                      = 234?PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_BAYER_12                  = 235?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_BAYER                     = 236?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_P016L                     = 237?*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_YV12                      = 238*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_NV12T                     = 239*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_S1_UINT                   = 240*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_S16_UINT                  = 241*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_S4_UINT                   = 242*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_S8_UINT                   = 243*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_I12_UNORM                 = 244*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_I16_UNORM                 = 245*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_I4_UNORM                  = 246*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_I8_UNORM                  = 247*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L12_UNORM                 = 248*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L12_A12_UNORM             = 249*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L12_A4_UNORM              = 250*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L16_A16_UNORM             = 251*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L4_UNORM                  = 252*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L4_A4_UNORM               = 253*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_L6_A2_UNORM               = 254*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_RGB8_ETC2                  = 255?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_SRGB8_ETC2                 = 256?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA8_ETC2_EAC                       = 257*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_SRGB8_ALPHA8_ETC2_EAC                = 258*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_R11_EAC                              = 259?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RG11_EAC                             = 260*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_SIGNED_R11_EAC                       = 261*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_SIGNED_RG11_EAC                      = 262*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_RGB8_PUNCHTHROUGH_ALPHA1_ETC2        = 263*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2       = 264*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_ALPHA                     = 265*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_INTENSITY                 = 266*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_LUMINANCE                 = 267*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RED                       = 268*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RED_RGTC1                 = 269*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RG                        = 270*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RG_RGTC2                  = 271*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RGB                       = 272*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RGB_BPTC_SIGNED_FLOAT     = 273*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT   = 274*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RGBA                      = 275*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_RGBA_BPTC_UNORM           = 276*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_SIGNED_RED_RGTC1          = 277*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_COMPRESSED_SIGNED_RG_RGTC2           = 27*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_COMPRESSED_SLUMINANCE                = 279*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_COMPRESSED_SLUMINANCE_ALPHA          = 280*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_COMPRESSED_SRGB                      = 281*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_COMPRESSED_SRGB_ALPHA                = 282*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_COMPRESSED_SRGB_ALPHA_BPTC_UNORM     = 283*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10G10B10A2_USCALE                   = 284?0*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R10G10B10A2_SSCALE                   = 285*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32G32B32A32_SSCALE                  = 286,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32G32B32_SSCALE                     = 287,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32G32_SSCALE                        = 288,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R16G16B16_SSCALE                     = 289,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32_SSCALE                           = 290,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R8G8B8_SSCALE                        = 291,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED, /*HSF_UNKOWN                               = 292*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 293*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 294*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 295*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 296*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 297*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 298*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 299*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 300*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 301*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 302*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 303*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 304*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 305*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 306*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 307*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 308*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 309*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 310*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 311*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 312*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 313*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 314*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 315*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 316*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 317*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 318*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 319*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,      /*HSF_UNKOWN                               = 320*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_4X4                        = 321*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_5X4                        = 322*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_5X5                        = 323*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_6X5                        = 324*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_6X6                        = 325*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_8X5                        = 326*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_8X6                        = 327*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_8X8                        = 328*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_10X5                       = 329*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_10X6                       = 330*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_10X8                       = 331*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_10X10                      = 332*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_12X10                      = 333*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,    /*HSF_RGBA_ASTC_12X12                      = 334*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED, /*HSF_RESERVED0                            = 335*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED, /*HSF_RESERVED1                            = 336*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_4X4_SRGB                   = 337*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_5X4_SRGB                   = 338*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_5X5_SRGB                   = 339*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_6X5_SRGB                   = 340*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_6X6_SRGB                   = 341*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_8X5_SRGB                   = 342*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_8X6_SRGB                   = 343*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_8X8_SRGB                   = 344*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_10X5_SRGB                  = 345*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_10X6_SRGB                  = 346*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_10X8_SRGB                  = 347*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_10X10_SRGB                 = 348*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_12X10_SRGB                 = 349*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,    /*HSF_RGBA_ASTC_12X12_SRGB                 = 350*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_RESERVED2                            = 351*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_RESERVED3                            = 352*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_3x3x3                      = 353,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_4x3x3                      = 354,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_4x4x3                      = 355,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_4x4x4                      = 356,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_5x4x4                      = 357,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_5x5x4                      = 358,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_5x5x5                      = 359,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_6x5x5                      = 360,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_6x6x5                      = 361,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP32,      /*HSF_RGBA_ASTC_6x6x6                      = 362,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_ASTC_RESERVED4                            = 363,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_ASTC_RESERVED5                            = 364,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_ASTC_RESERVED6                            = 365,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_ASTC_RESERVED7                            = 366,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_ASTC_RESERVED8                            = 367,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_RESERVED,  /*HSF_ASTC_RESERVED9                            = 368,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_3x3x3_SRGB                 = 369, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_4x3x3_SRGB                 = 370, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_4x4x3_SRGB                 = 371, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_4x4x4_SRGB                 = 372, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_5x4x4_SRGB                 = 373, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_5x5x4_SRGB                 = 374,*/\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_5x5x5_SRGB                 = 375,  */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_6x5x5_SRGB                 = 376, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_6x6x5_SRGB                 = 377, */\
   PS_OUT_RTFMT_RT0_DATA_FMT_FP16,      /*HSF_RGBA_ASTC_6x6x6_SRGB                 = 378,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64_UINT                             = 379,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64G64_UINT                          = 380,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64G64B64_UINT                       = 381,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64G64B64A64_UINT                    = 382,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,      /*HSF_R64_SINT                             = 383,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64G64_SINT                          = 384,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64G64B64_SINT                       = 385,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R64G64B64A64_SINT                    = 386,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,     /*HSF_R4G4B4X4_UNORM                       = 387,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,      /*HSF_R5G5B5X1_UNORM                       = 388,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_SNORM8,     /*HSF_R8G8B8X8_SNORM                       = 389,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT8,     /*HSF_R8G8B8X8_UINT                        = 390,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_SINT8,      /*HSF_R8G8B8X8_SINT                        = 391,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_R8G8B8X8_UNORM_SRGB                  = 392,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10,     /*HSF_R10G10B10X2_UNORM                    = 393,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM16,     /*HSF_R16G16B16X16_UNORM                   = 394,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_SNORM16,     /*HSF_R16G16B16X16_SNORM                   = 395,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP16,     /*HSF_R16G16B16X16_FLOAT                   = 396,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT16,     /*HSF_R16G16B16X16_UINT                    = 397,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_SINT16,     /*HSF_R16G16B16X16_SINT                    = 398,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_R32G32B32X32_FLOAT                   = 399,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UINT32,     /*HSF_R32G32B32X32_UINT                    = 400,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_SINT32,     /*HSF_R32G32B32X32_SINT                    = 401,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_S8_UINT_D24_UNORM                    = 402,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_D24_UNORM_S8_UINT                    = 403,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP32,     /*HSF_S8_UINT_D32_FLOAT                    = 404,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM24,      /*HSF_R24_UNORM                            = 405,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM24,      /*HSF_R24G24_UNORM                         = 406,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM24,      /*HSF_R24G24B24A24_UNORM                   = 407,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM10,      /*HSF_R10G10B10A10_UNORM                   = 408,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP16,         /*HSF_BC1_TYPELESS                         = 409,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,        /*HSF_B8G8R8A8_TYPELESS                   = 410,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_UNORM8,        /*HSF_B8G8R8X8_TYPELESS                   = 411,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP16,          /*HSF_BC2_TYPELESS                        = 412,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP16,          /*HSF_BC3_TYPELESS                        = 413,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP16,          /*HSF_BC4_TYPELESS                        = 414,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP32,          /*HSF_BC5_TYPELESS                        = 415,*/\
    PS_OUT_RTFMT_RT0_DATA_FMT_FP32,          /*DXGI_FORMAT_BC6H_TYPELESS               = 416,*/\
    PS_OUT_FMT_O0_DATA_FMT_FP32,             /*HSF_BC7_TYPELESS                        = 417,*/\
   }
//we now set 57 formats to the UAV format table. If need more, add them.
#define UAV_FORMAT \
{\
    ...
    CS_U_FMT_U0_DATA_FMT_RESERVED,      /*HSF_BC7_TYPELESS                        = 417,*/\
}
...
typedef enum
{
    ...
    D32_FLOAT              = 0x8,
    D24_UNORM_S8_UINT      = D24_UNORM | S8_UINT,  // D24_UNORM_S8_UINT    R24G8_TYPELESS, R24_UNORM_X8_TYPELESS, X24_TYPELESS_G8_UINT
    D32_FLOAT_S8_UINT      = D32_FLOAT | S8_UINT,  // D32_FLOAT_S8_UINT
...
typedef struct HWFORMAT_TABLE_ENTRY_E3K
{
    ...
    Hw_Surf_Format        Mapped2DDstFormat;
    Hw_Surf_Format        SuppressAlphaFormat;
    DEPTH_STENCIL_FORMAT  CompatibleDsFmt;
    COMPRESS_MXUFORMAT    CompressFmt;
    int                   ChannelMask;
    int                   bRtSupport;             // Can this format be used as RT
    int                   bBlockCompressed;       // Is this format block compressed
    int                   bYUY2;                  // Is this format YUY2
    int                   b96bpp;                 // Is this format 96bpp
    int                   bUnorm;                 // Is this format UNORM
    int                   bSnorm;                 // Is this format SNORM
    int                   bSrgb;                  // Is this format SRGB
    int                   bTypeless;              // Is this format typeless
    int                   bTexBuf3channel;        // Is this format R32/R16/R8 3channel
    int                   bFP32Mode;              // Is one of channel size > 24
    int                   bASTC;                  // Is ASTC format compress data
    int                   BlockWidth;             // ASTC block width
    int                   BlockHeight;            // ASTC block height
    int                   BlockDepth;             // ASTC block depth
    int                   ClrLineNum;             // Color line number for RT format
} HWFORMAT_TABLE_ENTRY_E3K;

typedef struct HWFORMAT_TABLE_ENTRY_PATCH
{
    Hw_Surf_Format ResourceFormat;
    HWFORMAT_TABLE_ENTRY_E3K hwFormatTable;
}HWFORMAT_TABLE_ENTRY_PATCH;

extern HWFORMAT_TABLE_ENTRY_E3K g_HwFormatTable_e3k[];
extern const HWFORMAT_TABLE_ENTRY_PATCH g_HwFormatTable_CHX004[];
extern int getPatchHwFormatTableSize(void);
#endif
