 ...
 *
 */
//    Spec Last Modified Time:  2022/2/15 18:15:52
...
#define _VCP_REGISTERS_H
    ...
    #define    BLOCK_VCP_TIMESTAMP "2022/2/15 18:15:52"
    #define    VCP_BLOCK                                                  0xC // match with BlockID.h
    #define    VCP_REG_LIMIT                                              0x13 // match with BlockID.h
#endif
...
#define        Reg_Fe_Framelvl_Memcount_Offset                            0x20
#define        Reg_Fe_Framelvl_Perf_Offset                                0x26
#define        Reg_Fe_Framelvl_Cmp_Memcount_Offset                        0x2F
#define        Reg_Fe_Timestamp_Count_Offset                              0x31
#define        Reg_Fe_Qeury_Reg_End_Offset                                0x33
#define        Reg_Be_Ila_Counter_Video_Offset                            0x12
#define        Reg_Be_Signature_Video_Offset                              0x19
#define        Reg_Be_S3vd_Enc_Avg_Dist_Offset                            0x33
#define        Reg_Be_Framelvl_Memcount_Offset                            0x34
#define        Reg_Be_Framelvl_Perf_Offset                                0x39
#define        Reg_Be_Framelvl_Cmp_Memcount_Offset                        0x61
#define        Reg_Be_Framelvl_Perf_New_Added_Offset                      0x63
#define        Reg_Be_Timestamp_Count_Offset                              0x82
#define        Reg_Be_Decode_Status_Offset                                0x85
#define        Reg_Be_Qeury_Reg_End_Offset                                0x87
#define        Reg_Vcp_Set_Regs_Offset                                    0x0

// Block constant definition

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////            VCP Block (Block ID = 12) Register Definitions                            ///////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
typedef union
{
    struct
    {
        unsigned int     Wroutofrange          : 1;   // Write out of surface boundary happened flag
        unsigned int     Dont_Kickoff_Be_Flag  : 1;   // For C-Model simulate FE/BE parallel for trans-coding, we
                                                      // need to kickoff C-Model only for decoder path
        unsigned int     Flush_Be_Flag         : 1;   // For C-Model simulate BE flush
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Fe_Vdcw_Signature_Low;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Fe_Vdcw_Signature_High;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Fe_Signature_Reserved0;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Fe_Signature_Reserved1;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Fe_Signature_Reserved2;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Fe_Signature_Reserved3;
...
typedef struct _Group_Fe_Framelvl_Memcount
{
    ...
    Reg_S3vd_Fe_Dma_Buffull_Count    reg_S3vd_Fe_Dma_Buffull_Count;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Fe_Timestamp_Count_Low;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Fe_Timestamp_Count_High;

typedef struct _Group_Fe_Timestamp_Count
{
    Reg_S3vd_Fe_Timestamp_Count_Low  reg_S3vd_Fe_Timestamp_Count_Low;
    Reg_S3vd_Fe_Timestamp_Count_High reg_S3vd_Fe_Timestamp_Count_High;
} Reg_Fe_Timestamp_Count_Group;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Be_Vdcw_Signature_Low;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Be_Vdcw_Signature_High;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Be_Signatrue_Reserved0;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Be_Signatrue_Reserved1;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Be_Signatrue_Reserved2;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Bci_Be_Signatrue_Reserved3;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Be_Timestamp_Count_Low;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Be_Timestamp_Count_High;

typedef union
{
    struct
    {
        unsigned int     Fe_Slice_Group_Idx    : 2;   // FE Slice group index, each frame can have 4 slice group in
                                                      // max
        unsigned int     Fe_Frame_Idx          : 6;   // FE frame index, keep lower 6 bit
        unsigned int     Fe_Sequence_Idx       : 7;   // FE Seq index
        unsigned int     Fe_Reserved           : 1;   // reserverd
        unsigned int     Be_Slice_Group_Idx    : 2;   // FE Slice group index, each frame can have 4 slice group in
                                                      // max
        unsigned int     Be_Frame_Idx          : 6;   // FE frame index, keep lower 6 bit
        unsigned int     Be_Sequence_Idx       : 7;   // FE Seq index
        unsigned int     Decoupled_In_One_Rbuf_Package
                                               : 1;   // fe&be run in decoupled mode
    } reg;
    unsigned int uint;
} Reg_S3vd_Be_Decouple_Status;

typedef struct _Group_Be_Timestamp_Count
{
    Reg_S3vd_Be_Timestamp_Count_Low  reg_S3vd_Be_Timestamp_Count_Low;
    Reg_S3vd_Be_Timestamp_Count_High reg_S3vd_Be_Timestamp_Count_High;
    Reg_S3vd_Be_Decouple_Status      reg_S3vd_Be_Decouple_Status;
} Reg_Be_Timestamp_Count_Group;
...
typedef union
{
    ...
    unsigned int uint;
} Reg_S3vd_Be_Decode_Status_High;

typedef struct _Group_Be_Decode_Status
{
    Reg_S3vd_Be_Decode_Status_Low    reg_S3vd_Be_Decode_Status_Low;
    Reg_S3vd_Be_Decode_Status_High   reg_S3vd_Be_Decode_Status_High;
} Reg_Be_Decode_Status_Group;
...
typedef union
{
    struct
    {
        unsigned int     Hang_Wait_Cnt         : 24;  // hang_wait_cnt
        unsigned int     Error_Detect_Enable   : 1;   // enable/disable error detect function
        unsigned int     Power_Gating_Enable   : 1;   // Enable power gating feature to save power
        unsigned int     Reserved              : 2;   // reserved
        unsigned int     Swhalt_Enable         : 1;   // swhalt_enable
        unsigned int     Hang_Notran_Reset_En  : 1;   // hang_notran_reset_en
        unsigned int     Sig_Clear_Disable     : 1;   // sig_clear_disable
        unsigned int     Hang_Auto_Reset_En    : 1;   // hang_auto_reset_en
    } reg;
    unsigned int uint;
} Reg_Set_Reg_0;
...
typedef union
{
    struct
    {
        unsigned int     Sig_Sel               : 4;   // sig_sel
        unsigned int     Sig_Mode              : 1;   // sig_mode
        unsigned int     Sig_Lock_Dec          : 1;   // sig_lock_dec
        unsigned int     Sig_Lock_Enc          : 1;   // sig_lock_enc
        unsigned int     Mem_Check_Enable      : 1;   // mem_check_enable
        unsigned int     Sig_Lock_Cnt          : 24;  // sig_lock_cnt
    } reg;
    unsigned int uint;
} Reg_Set_Reg_1;
...
typedef union
{
    struct
    {
        unsigned int     Dec_Sig_Fail_Bk       : 1;   // dec_sig_fail_bk
        unsigned int     Enc_Sig_Fail_Bk       : 1;   // enc_sig_fail_bk
        unsigned int     Mmio_Nout             : 1;   // MMIO_NOUT
        unsigned int     Mmio_Qlp              : 1;   // MMIO_QLP
        unsigned int     Tile_Swizzle_En       : 1;   // TILE_SWIZZLE_EN
        unsigned int     Vcp_Clear_En          : 1;   // VCP_CLEAR_EN
        unsigned int     Vcp_Int_En            : 1;   // VCP_INT_EN
        unsigned int     Tb_Int_En             : 1;   // TB_INT_EN
        unsigned int     Qtm_Int_En            : 1;   // QTM_INT_EN
        unsigned int     Hang_Rst_Int_En       : 1;   // hang_rst_int_en
        unsigned int     Sw_Rst_Int_En         : 1;   // sw_rst_int_en
        unsigned int     Sw_Rst_Idle_Cnt_En    : 1;   // sw_rst_idle_cnt_en
        unsigned int     S3vd_Enc_Clk_Disable  : 1;   // Encoder clock disable signal
        unsigned int     Vcp_Always_Busy       : 1;   // No idle state for VCP flag
        unsigned int     Vp9_Partitionprob_Select
                                               : 1;   // reserved1
        unsigned int     Reserved1             : 17;  // reserved1
    } reg;
    unsigned int uint;
} Reg_Set_Reg_2;
...
typedef union
{
    struct
    {
        unsigned int     Codec_Type            : 8;   // codec_type
        unsigned int     Dcp_Mode              : 2;
...
typedef union
{
    struct
    {
        unsigned int     Baseaddr_L            : 32;  // BaseAddr[31:0]
    } reg;
    unsigned int uint;
} Reg_Set_Reg_4;
...
typedef union
{
    struct
    {
        unsigned int     Baseaddr_H            : 8;   // BaseAddr[39:32]
        unsigned int     Bl_Slot_Idx           : 18;  // Bl_Slot_Idx
        unsigned int     Reserved1             : 6;   // reserved1
    } reg;
    unsigned int uint;
} Reg_Set_Reg_5;
...
typedef union
{
    struct
    {
        unsigned int     Rangesize             : 32;  // RangeSize
    } reg;
    unsigned int uint;
} Reg_Set_Reg_6;
...
typedef union
{
    struct
    {
        unsigned int     Bnewframestart        : 1;   // bNewFrameStart
        unsigned int     Udrawid_L             : 2;   // uDrawID
        unsigned int     Reserved0             : 4;   // Reserved
        unsigned int     Udrawid_H             : 4;   // high bits of drawID
...
typedef union
{
    struct
    {
        unsigned int     Error_Level           : 4;   // bNewFrameStart
        unsigned int     Syntax_Max_Value      : 28;  // Syntax_max_value
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Count_Mb_Perf_Flag    : 1;   // MB performance count dump enable flag
        unsigned int     Reserved              : 5;
        unsigned int     Vld_Mb_Perf_Base_L    : 26;  // VLD module's MB performance base address
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Vld_Mb_Perf_Base_H    : 8;   // VLD module's MB performance base address bit[39:32]
        unsigned int     Bl_Slot_Idx           : 18;  // VLD module's MB performance surface's Bl_Slot_Idx
        unsigned int     Reserved1             : 6;   // reserved1
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Count_Mb_Perf_Flag    : 1;   // MB performance count dump enable flag
        unsigned int     Reserved              : 5;
        unsigned int     Vle_Mb_Perf_Base_L    : 26;  // VLE module's MB performance base address
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Vle_Mb_Perf_Base_H    : 8;   // VLE module's MB performance base address bit[39:32]
        unsigned int     Bl_Slot_Idx           : 18;  // VLE module's MB performance surface's Bl_Slot_Idx
        unsigned int     Reserved1             : 6;   // reserved1
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        ...
        unsigned int     Encoder_Mb_Perf_Base_L
                                               : 26;  // Encoder/MEE module's MB performance base address
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Encoder_Mb_Perf_Base_H
                                               : 8;   // Encoder/MEE module's MB performance base address
                                                      // bit[39:32]
        unsigned int     Bl_Slot_Idx           : 18;  // Encoder/MEE module's MB performance surface's
                                                      // Bl_Slot_Idx
        unsigned int     Reserved1             : 6;   // reserved1
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Count_Mb_Perf_Flag    : 1;   // MB performance count dump enable flag
        unsigned int     Reserved              : 5;
        unsigned int     Ftq_Mb_Perf_Base_L    : 26;  // Encoder FTQ module's MB performance base address
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Ftq_Mb_Perf_Base_H    : 8;   // Encoder FTQ module's MB performance base address
                                                      // bit[39:32]
        unsigned int     Bl_Slot_Idx           : 18;  // Encoder FTQ module's MB performance surface's
                                                      // Bl_Slot_Idx
        unsigned int     Reserved1             : 6;   // reserved1
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Ftq_Mb_Perf_Slice_Offset
                                               : 32;  // Encoder FTQ module's MB performance slice offset
                                                      // (non-zero for only GDR case)
    } reg;
    unsigned int uint;
...
typedef union
{
    struct
    {
        unsigned int     Enable_Bypass_1cycperbit
                                               : 1;   // HEVC DEC VLD performance counter by pass hide 1 cycle add
                                                      // control flag
        unsigned int     Enabe_Nonzerolvl_Puttb2cyc
                                               : 1;   // HEVC DEC VLD performance counter puttb hide 2 cycle add
                                                      // control flag
        unsigned int     Enable_Residual_Coding_Change
                                               : 1;   // HEVC DEC VLD performance counter hide cycle in residual
                                                      // coding function add control flag
        unsigned int     Enable_Cunit_Intra_Change
                                               : 1;   // HEVC DEC VLD performance counte hide cycle add in cunit
                                                      // intra function control flag
        unsigned int     Enable_Sao_Change     : 1;   // HEVC DEC VLD performance counter hide cycle add in sao
                                                      // stage control flag
        unsigned int     Enable_Cunit_Change   : 1;   // HEVC DEC VLD performance counter hide cycle add in cunit
                                                      // control flag
        unsigned int     Enable_Codingquadtree_Change
                                               : 1;   // HEVC DEC VLD performance counter hide cycle add in coding
                                                      // quadtree function control flag
...
typedef union
{
    struct
    {
        unsigned int     Insert_Dma_Error      : 1;   // Flag to indicate whether to insert error in DMA command
        unsigned int     Reserved              : 7;   // Reserved
        unsigned int     Error_Interval        : 24;  // Interval of insert error in current frame
    } reg;
    unsigned int uint;
...
typedef union
{
    ...
    {
        unsigned int     Reserved              : 5;
        unsigned int     Base_Addr_L           : 27;  // base address low for BE-BCI prefetch memory
    } reg;
    unsigned int uint;
...
typedef struct _Vcp_regs
{
    ...
    Reg_Fe_Timestamp_Count_Group     reg_Fe_Timestamp_Count;
    ...
    Reg_Be_Timestamp_Count_Group     reg_Be_Timestamp_Count;
    Reg_Be_Decode_Status_Group       reg_Be_Decode_Status;
