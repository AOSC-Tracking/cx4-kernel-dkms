...
{
    int (*direct_get_miu_counter)(adapter_t *adapter, zx_miu_list_item_t *miu_table, unsigned int miu_table_length,int force_read);
    int  (*calculate_engine_usage)(adapter_t *, zx_hwq_info *);
